...
const planets = [
  ...
  },
  {
    id: "venus",
    name: "Updates",
    subtitle: "What Have I Finished?",
    facts: ["PDF accessibility remediation on most of the Form 990 & 199"],
    icon: HardHatIcon,
    size: "w-36 h-36 md:w-52 md:h-52",
  },
  {
    id: "earth",
    name: "What am I Currently Working on?",
    subtitle: "Check Them Out!",
    facts: ["Research on how nextauth works and how backend works."],
    icon: Globe,
    size: "w-36 h-36 md:w-52 md:h-52",
  },
  {
    ...
    name: "What's On Deck?",
    facts: [
      "Refactor backoffice signin so that only authorized users can sign in and see not anybody.",
      "Finish pdf accessibility remediation on all form 990 & 199.",
    ],
    icon: Orbit,
